...
Presets, performer names, channel and bus labels, the console list and your
settings are stored as ordinary files on the device you are using. They are
not transmitted anywhere unless you set up sharing.
...
In every case the data is in your account, not ours. Removing someone's
access is done in that service, not here.
...
The app talks to your console over your **local network only**. Channel
names, levels and other console data move between the app and the desk in
front of you. None of it leaves your network because of this app.

The app asks for local network permission for this reason, and for no other.

## Subscriptions and payment

Subscriptions are handled entirely by **Apple**. Payment details go to Apple,
never to us. We receive sales reports from Apple that show totals and
countries; they do not identify you.
...
If this policy changes in a way that affects how your information is handled,
the app will be updated and the date at the top of this page will change.
